...
const config: Config = {
  ...
  url: 'https://entity-ws.paion-data.dev',
  baseUrl: '/',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
              'https://github.com/paion-data/entity-ws/tree/master/docs',
        },
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://entity-ws.paion-data.dev/apidocs",
          label: "API",
          position: "left",
        },
        {
          href: 'https://github.com/paion-data/entity-ws',
          label: ' ',
          position: 'right',
