...
Entity-WS-Project-intellij-code-style.xml file in the root of the repo. The setting for the project will
appear as a new Scheme named "Entity-WS-Project" under IDE's __Editor__ -> __Code Style__ section.
