...
Entity WS has
[Docker-based integration tests](https://github.com/paion-data/entity-ws/blob/master/src/test/java/org/paiondata/ws/entity/arango/ArangoControllerIT.java);
it also supports
[running template webserivce in Docker](https://github.com/paion-data/entity-ws/blob/master/src/test/java/org/paiondata/ws/entity/DockerComposeIT.java).
