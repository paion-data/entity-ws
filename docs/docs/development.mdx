...
Entity WS has
[Docker-based integration tests](https://github.com/QubitPi/entity-ws/blob/master/src/test/java/org/qubitpi/ws/entity/arango/ArangoControllerIT.java);
it also supports
[running template webserivce in Docker](https://github.com/QubitPi/entity-ws/blob/master/src/test/java/org/qubitpi/ws/entity/DockerComposeIT.java).
...
[Entity-WS-Project-intellij-code-style.xml](https://github.com/QubitPi/entity-ws/blob/master/Entity-WS-Project-intellij-code-style.xml)
...
```console
git clone git@github.com:paion-data/entity-ws.git
cd entity-ws
mvn clean package
